...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { active: @name.active, author: @name.author, available: @name.available, description: @name.description, edition: @name.edition } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { active: @name.active, author: @name.author, available: @name.available, description: @name.description, edition: @name.edition } }
