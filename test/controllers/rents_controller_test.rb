...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { book_id: @rent.book_id, bring_back: @rent.bring_back, obs: @rent.obs, returned: @rent.returned, student_id: @rent.student_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { book_id: @rent.book_id, bring_back: @rent.bring_back, obs: @rent.obs, returned: @rent.returned, student_id: @rent.student_id } }
